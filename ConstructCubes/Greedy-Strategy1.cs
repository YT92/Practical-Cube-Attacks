...
namespace gorubi
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //int startround = 799;
            //List<uint> seedcube = new List<uint>() {11,13,15,18,22,26,30,36,38,43,49,51,52,55,57,62,65,66 };//62, 68, 70, 73, 76, 78
           // List<uint> curcube = new List<uint>() { 11,13,15,18,22,26,30,36,38,43,49,51,52,55,57,62,65,66};
          // List<uint> seedcube = new List<uint>() {2,5,7,10,15,17,26,32,33,35,50,55,56,59,61,63,66};//62, 68, 70, 73, 76, 78
           // List<uint> curcube = new List<uint>() { 2,5,7,10,15,17,26,32,33,35,50,55,56,59,61,63,66};
           //List<uint> seedcube = new List<uint>() {0,2,4,7,9,13,15,17,32,33,37,45,49,50};//62, 68, 70, 73, 76, 78
           //List<uint> curcube = new List<uint>() { 0,2,4,7,9,13,15,17,32,33,37,45,49,50};
            //List<uint> seedcube = new List<uint>() {2,5,7,10,14,17,20,25,30,33,36,38,41,46,52,57,62};//62, 68, 70, 73, 76, 78
           //List<uint> curcube = new List<uint>() { 2,5,7,10,14,17,20,25,30,33,36,38,41,46,52,57,62};z
           //7//List<uint> seedcube = new List<uint>() {2,5,6,9,13,16,21,23,27,29,32,34,36,38,40,42,45};//62, 68, 70, 73, 76, 78
           //List<uint> curcube = new List<uint>() {2,5,6,9,13,16,21,23,27,29,32,34,36,38,40,42,45};
           //List<uint> seedcube = new List<uint>() {0,2,6,7,9,11,13,15,18,20,22,24,35,37,39,42};//62, 68, 70, 73, 76, 78
           //List<uint> curcube = new List<uint>() {0,2,6,7,9,11,13,15,18,20,22,24,35,37,39,42};
           //9//List<uint> seedcube = new List<uint>() {5,7,9,11,16,18,22,24,26,28,30,33,37,40,42,47};//62, 68, 70, 73, 76, 78
           //List<uint> curcube = new List<uint>() {5,7,9,11,16,18,22,24,26,28,30,33,37,40,42,47};
            //List<uint> seedcube = new List<uint>() {2,6,8,10,11,15,19,21,25,29,30,32,34,36,39,41,43,45,50};//62, 68, 70, 73, 76, 78
            //List<uint> curcube = new List<uint>() {2,6,8,10,11,15,19,21,25,29,30,32,34,36,39,41,43,45,50};
            //List<uint> seedcube = new List<uint>(){5,7,9,11,13,16,18,20,26,28,30,31,33,37,40,44,46};
            //List<uint> curcube = new List<uint>(){5,7,9,11,13,16,18,20,26,28,30,31,33,37,40,44,46};
            //List<uint> seedcube = new List<uint>(){0,2,4,7,10,13,15,17,19,20,25,29,34,38,41,52,58};
            //List<uint> curcube = new List<uint>(){0,2,4,7,10,13,15,17,19,20,25,29,34,38,41,52,58};
            //List<uint> seedcube = new List<uint>(){7,9,11,13,16,18,20,28,31,33,37,42,44,46,47};
           // List<uint> curcube = new List<uint>(){7,9,11,13,16,18,20,28,31,33,37,42,44,46,47};
           //List<uint> seedcube = new List<uint>(){4,6,10,11,15,17,19,21,25,29,32,34,36,39,41,43,50};
           //List<uint> curcube = new List<uint>(){4,6,10,11,15,17,19,21,25,29,32,34,36,39,41,43,50};
          // List<uint> seedcube = new List<uint>(){0,5,6,7,9,11,13,15,18,22,24,26,30,32,37,39,42};
           //List<uint> curcube = new List<uint>(){0,5,6,7,9,11,13,15,18,22,24,26,30,32,37,39,42};
           //List<uint> seedcube = new List<uint>(){4,6,8,11,13,16,19,21,23,26,28,30,36,38,40,42,44};
           //List<uint> curcube = new List<uint>(){4,6,8,11,13,16,19,21,23,26,28,30,36,38,40,42,44};
          // List<uint> seedcube = new List<uint>(){0,2,4,10,13,15,17,19,25,29,32,34,38,41,52,58,60};
          // List<uint> curcube = new List<uint>(){0,2,4,10,13,15,17,19,25,29,32,34,38,41,52,58,60};
           List<uint> seedcube = new List<uint>(){ 4,6,10,11,15,17,19,21,25,29,32,34,36,39,41,43,50,2,69,79,8,27,0,1,28,71,13,45,23,26,38,76};
           List<uint> curcube = new List<uint>(){ 4,6,10,11,15,17,19,21,25,29,32,34,36,39,41,43,50,2,69,79,8,27,0,1,28,71,13,45,23,26,38,76};
